...
public enum EventType {
  ...
  , WARRIOR_ATTACK_MISS("В игре '%s' у игрока '%s' воин '%s %s' хорошо метил, но промахнулся")
  , WARRIOR_ATTACK_MISS_BUT_LUCK("В игре '%s' у игрока '%s' воин '%s %s' хорошо метил, но удар был кос, однако удача повернула его оружие и направила точно в цель с увеличенной силой")
  , WARRIOR_ATTACK_LUCK("В игре '%s' у игрока '%s' воину '%s %s' улыбнулась удача. Удар нанесен с увеличенной силой")

  , WARRIOR_HAS_LUCK("В игре '%s' воину '%s %s' игрока '%s' улыбнулась удача %s")
  , WARRIOR_WAS_ATTACKED_BY_ENEMY("В игре '%s' воин '%s %s' игрока '%s' нанес оружием %s воину '%s %s' игрока %s урон: %s")
